...
import { Phone, Mail, MapPin, Truck, Shield, Clock, ArrowRight } from 'lucide-react';

const FALLBACK_PRODUCTS = [
  { id: '1', name: 'Ferforje', slug: 'ferforje', image: '/images/11.jpg', shortDescription: 'Dekoratif ve işlevsel ferforje demir ürünleri. Kapı, pencere parmaklığı ve bahçe uygulamalarında kullanılır.' },
  { id: '2', name: 'Köşebent', slug: 'kosebent', image: '/images/13.jpg', shortDescription: 'Yapı ve endüstriyel uygulamalar için yüksek kaliteli çelik köşebent profiller.' },
  { id: '3', name: 'Sac', slug: 'sac', image: '/images/9.jpg', shortDescription: 'Düz ve oluklu sac çeşitleri. Her türlü endüstriyel ve yapısal uygulama için.' },
  { id: '4', name: 'İşlemeli Profil', slug: 'islemeli-profil', image: '/images/2.jpg', shortDescription: 'Özel işlemeli çelik profiller. Endüstriyel ve dekoratif uygulamalar için idealdir.' },
  { id: '5', name: 'Boru', slug: 'boru', image: '/images/5.jpg', shortDescription: 'Çelik ve galvaniz boru çeşitleri. Yapı, tesisat ve endüstriyel kullanım için.' },
  { id: '6', name: 'I Demiri', slug: 'i-demiri', image: '/images/14.jpg', shortDescription: 'Yapı inşaatında taşıyıcı sistem olarak kullanılan yüksek dayanımlı I profil demirler.' },
  { id: '7', name: 'U Demiri', slug: 'u-demiri', image: '/images/12.jpg', shortDescription: 'Endüstriyel uygulamalarda yaygın kullanılan U profil çelik ürünler.' },
  { id: '8', name: 'Trapez Sac', slug: 'trapez-sac', image: '/images/4.jpg', shortDescription: 'Çatı ve cephe kaplama için trapez sac. Dayanıklı ve uzun ömürlü.' },
  { id: '9', name: 'Elektrot', slug: 'elektrot', image: '/images/8.jpg', shortDescription: 'Kaynak uygulamaları için çeşitli elektrot çeşitleri.' },
  { id: '10', name: 'OSB Levha', slug: 'osb-levha', image: '/images/1.jpg', shortDescription: 'Yapı ve mobilya uygulamaları için yüksek yoğunluklu OSB levha.' },
  { id: '11', name: 'Tekerlek', slug: 'tekerlek', image: '/images/15.jpeg', shortDescription: 'Endüstriyel taşıma ve platform sistemleri için çeşitli tekerlek tipleri.' },
  { id: '12', name: 'Makara', slug: 'makara', image: '/images/6.jpg', shortDescription: 'Çelik halat ve kablo sistemleri için endüstriyel makara çeşitleri.' },
];
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
            {products.map((product) => (
              <Link
                ...
                className="group bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden flex flex-col"
              >
                <div className="w-full aspect-square overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
                  <img
                    src={product.image}
                    alt={product.name}
                    loading="lazy"
                ...
                <div className="p-5 flex flex-col flex-1">
                  <h3 className="text-lg font-bold text-gray-800 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-purple-600 transition-all duration-300">
                    {product.name}
                  </h3>
                  ...
                  <span className="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-blue-600 group-hover:text-purple-600 transition-colors">
                    Devamını Gör <ArrowRight size={14} />
                  </span>
                </div>
              </Link>
            ))}
